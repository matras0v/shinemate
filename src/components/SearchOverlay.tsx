        ...
        >
          ...
          >
            <div className="flex items-center gap-3 border-b border-graphite/[0.1] px-5 py-4">
              <Search size={18} className="shrink-0 text-graphite/40" />
              <input
                ref={inputRef}
                value={query}
                ...
                className="min-w-0 flex-1 bg-transparent text-[1rem] text-graphite outline-none placeholder:text-graphite/35"
              />
              <button
                type="button"
                onClick={onClose}
            ...
            <div className="max-h-[60vh] overflow-y-auto overscroll-contain">
              {query.trim() === '' ? (
                <p className="px-5 py-8 text-center text-[0.875rem] text-graphite/40">
                      ...
                      <li key={product.slug}>
                        ...
                        >
                          ...
                          <span className="min-w-0 flex-1">
                            ...
                            <span className="block truncate text-[0.75rem] text-graphite/45">
                              {product.kind}
                            </span>
                          </span>
                          <span className="shrink-0 text-[0.8125rem] text-graphite/60">
