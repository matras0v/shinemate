      ...
      >
        ...
        <div className="mt-6 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <motion.p variants={rise} className="lead max-w-[38ch] text-slate">
            {showSlider
              ? 'Слева — лак с голограммами и риской после неаккуратной мойки. Справа — тот же капот после машинной полировки: отражение держит форму и глубину.'
              : 'Вокруг — лак с голограммами и риской после неаккуратной мойки. В окне — тот же капот после машинной полировки: отражение держит форму и глубину.'}
          </motion.p>
        </div>
      </motion.div>
