      ...
      <div className="shell grid items-center gap-10 lg:grid-cols-2 lg:items-stretch lg:gap-16 xl:gap-24">
        ...
        >
          ...
          <motion.p variants={rise} className="lead mt-6 max-w-[46ch] text-ash">
            ...
            подготовки кузова: роторные и эксцентриковые машинки, шлифовальные
            машинки, аккумуляторные платформы, подложки, круги и пасты. Линейка
            собрана так, чтобы машинка, подложка и круг работали как один инструмент.
          </motion.p>
          {/* Про завод и производство здесь сознательно ничего нет: сайт —
        ...
        <div className="relative min-w-0 lg:col-start-2 lg:row-span-2 lg:row-start-1">
          ...
          <motion.img
            ...
            width={890}
            height={725}
            alt="Роторная машинка ShineMate с подложкой, поролоновым кругом и полировальными пастами V-Range"
            loading="lazy"
            decoding="async"
