    ...
    >
      <div className="shell">
        ...
        >
          ...
          >
            <p className="font-mono text-[0.6875rem] uppercase tracking-[0.24em] text-titanium">
              Система
            </p>
      ...
      {/*
        Ряд конкретных позиций отсюда переехал в отдельную сцену
        SystemAssembly ниже по странице: там та же связка не просто
        перечислена, а собирается по мере прокрутки. Дублировать её здесь
        значило бы показать одно и то же дважды подряд.
      */}
      <div className="shell mt-10">
        <motion.p {...riseProps(reduced, { y: 24, amount: 0.5 })} className="lead max-w-[62ch] text-slate">
