...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    lead: 'Эксцентриковые машины балансируются так, чтобы гасить вибрацию на рабочих оборотах.',
    points: [
  ...
  },
  {
    ...
    points: [
      'Чип в батарее и в машине согласуют режим заряда',
      ...
      <div className="shell">
        <motion.div {...revealProps(reduced, stagger(0, 0.09))} className="max-w-[48ch]">
          ...
          <motion.p variants={rise} className="lead mt-6 text-graphite/65">
            ...
            круга, баланс машины и то, как инструмент работает с питанием.
          </motion.p>
        </motion.div>
