...
export const products: Product[] = [
  ...
  // разные диаметры одного и того же круга, а не разные товары.
  {
    ...
    lead: 'Ровная рабочая поверхность без рельефа — давление на лак одинаковое по всей площади круга, без выступов, которые прожимаются сильнее. Зелёная градация T120 быстро снимает глубокие царапины, брызги и тяжёлые загрязнения, работает даже с устойчивыми к абразиву покрытиями и высокими керамическими красками.',
    specs: [
  ...
  },
  {
    ...
    lead: 'Ровная рабочая поверхность без рельефа — давление на лак одинаковое по всей площади круга, без выступов, которые прожимаются сильнее. Жёлтая градация T80 мягче по конструкции: интенсивно устраняет глубокие царапины, брызги, серьёзные следы полировки и тяжёлое окисление в паре с абразивными составами.',
    specs: [
  ...
  },
  {
    ...
    lead: 'Ровная рабочая поверхность без рельефа — давление на лак одинаковое по всей площади круга, без выступов, которые прожимаются сильнее. Синяя (встречается и коричневая) градация T60 средней жёсткости умеренно снимает царапины и следы шлифовки 1500–2000 зернистости, устраняет следы полировочных составов.',
    specs: [
  ...
  },
  {
    ...
    lead: 'Ровная рабочая поверхность без рельефа — давление на лак одинаковое по всей площади круга, без выступов, которые прожимаются сильнее. Оранжевая градация T40 действует легко: убирает мелкие царапины и круги от полировки, оставляя гладкую поверхность — подходит и для одноступенчатой полировки с абразивными составами.',
    specs: [
  ...
  },
  {
    ...
    lead: 'Ровная рабочая поверхность без рельефа — давление на лак одинаковое по всей площади круга, без выступов, которые прожимаются сильнее. Красная (встречается и серая) градация T10 действует мягче всего: убирает мельчайшие следы полировки, царапины от мойки и матовые участки, с финишными составами оставляет безупречно гладкое покрытие.',
    specs: [
