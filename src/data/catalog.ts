...
export const products: Product[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: '23854-04', label: '5" (123 мм), M8, 110 г — для машин EX 5"', rrp: 1280, note: 'Фото — общее для линейки Multi-hole, диаметр и вес этого исполнения — как в названии.' },
      { sku: '23465-04', label: '6" (148 мм), M8, 134 г — для машин EX 6"', rrp: 1570, note: 'Фото — общее для линейки Multi-hole, диаметр и вес этого исполнения — как в названии.' },
    ],
