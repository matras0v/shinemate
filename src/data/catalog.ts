...
export const products: Product[] = [
  ...
  // разные диаметры одного и того же круга, а не разные товары.
  {
    ...
    lead: 'Плоская рабочая поверхность даёт равномерное пятно контакта. Зелёная градация T120 — самый агрессивный рез в линейке, для тяжёлой коррекции.',
    specs: [
    ...
    variants: [
      { sku: '34124-9', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34126-9', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34127-9', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    lead: 'Плоская рабочая поверхность даёт равномерное пятно контакта. Жёлтая градация T80 — сильный рез для коррекции средней тяжести.',
    specs: [
    ...
    variants: [
      { sku: '34124-1', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34126-1', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34127-1', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    lead: 'Плоская рабочая поверхность даёт равномерное пятно контакта. Синяя градация T60 — средний рез, промежуточный этап полировки.',
    specs: [
    ...
    variants: [
      { sku: '34124-6', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34126-6', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34127-6', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    lead: 'Плоская рабочая поверхность даёт равномерное пятно контакта. Оранжевая градация T40 — лёгкий рез перед финишем.',
    specs: [
    ...
    variants: [
      { sku: '34124-4', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34126-4', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34127-4', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    lead: 'Плоская рабочая поверхность даёт равномерное пятно контакта. Красная градация T10 — финишный круг без реза, под самый глубокий глянец.',
    specs: [
    ...
    variants: [
      { sku: '34124-7', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34126-7', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34127-7', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    category: 'pads',
    kind: 'Поролоновый круг, тяжёлый рез',
    lead: 'Рельефная ячеистая поверхность лучше отводит тепло и распределяет пасту, чем плоская. Зелёная градация T120 — самый агрессивный рез в линейке.',
    specs: [
      { label: 'Градация', value: 'T120, зелёный' },
      { label: 'Толщина', value: '25 мм' },
      { label: 'Центральное отверстие', value: '22 мм у 6" и 7"' },
    ...
    variants: [
      { sku: '34114-9', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34116-9', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34117-9', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    category: 'pads',
    kind: 'Поролоновый круг, сильный рез',
    lead: 'Рельефная ячеистая поверхность лучше отводит тепло и распределяет пасту. Жёлтая градация T80 — сильный рез для коррекции средней тяжести.',
    specs: [
      { label: 'Градация', value: 'T80, жёлтый' },
      { label: 'Толщина', value: '25 мм' },
      { label: 'Центральное отверстие', value: '22 мм у 6" и 7"' },
    ...
    variants: [
      { sku: '34114-1', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34116-1', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34117-1', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    category: 'pads',
    kind: 'Поролоновый круг, средний рез',
    lead: 'Рельефная ячеистая поверхность лучше отводит тепло и распределяет пасту. Синяя градация T60 — средний рез, промежуточный этап полировки.',
    specs: [
      { label: 'Градация', value: 'T60, синий' },
      { label: 'Толщина', value: '25 мм' },
      { label: 'Центральное отверстие', value: '22 мм у 6" и 7"' },
    ...
    variants: [
      { sku: '34114-6', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34116-6', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34117-6', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    category: 'pads',
    kind: 'Поролоновый круг, лёгкий рез',
    lead: 'Рельефная ячеистая поверхность лучше отводит тепло и распределяет пасту. Оранжевая градация T40 — лёгкий рез перед финишем.',
    specs: [
      { label: 'Градация', value: 'T40, оранжевый' },
      { label: 'Толщина', value: '25 мм' },
      { label: 'Центральное отверстие', value: '22 мм у 6" и 7"' },
    ...
    variants: [
      { sku: '34114-4', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34116-4', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34117-4', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    category: 'pads',
    kind: 'Поролоновый круг, финиш',
    lead: 'Рельефная ячеистая поверхность лучше отводит тепло и распределяет пасту. Красная градация T10 — финишный круг без реза, под самый глубокий глянец.',
    specs: [
      { label: 'Градация', value: 'T10, красный' },
      { label: 'Толщина', value: '25 мм' },
      { label: 'Центральное отверстие', value: '22 мм у 6" и 7"' },
    ...
    variants: [
      { sku: '34114-7', label: '4" (100 мм)', rrp: 635, axis1: '4"' },
      { sku: '34116-7', label: '6" (150 мм)', rrp: 635, axis1: '6"' },
      { sku: '34117-7', label: '7" (180 мм)', rrp: 635, axis1: '7"' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: '41150', label: '130 мм', rrp: 450, axis1: '130 мм' },
      { sku: '41160', label: '155 мм', rrp: 450, axis1: '155 мм' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: '41955-A', label: '134 мм', rrp: 550, axis1: '134 мм' },
      { sku: '41965-A', label: '159 мм', rrp: 550, axis1: '159 мм' },
    ],
    axisLabel: 'Размер',
    image: 'catalog-media/wool-t130.webp',
    imageWidth: 700,
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: '41755', label: '134 мм', rrp: 490, axis1: '134 мм' },
      { sku: '41765', label: '159 мм', rrp: 490, axis1: '159 мм' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: '41362-7', label: '134 мм', rrp: 550, axis1: '134 мм' },
      { sku: '41372-7', label: '159 мм', rrp: 550, axis1: '159 мм' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: '41855', label: '134 мм', rrp: 490, axis1: '134 мм' },
      { sku: '41865', label: '159 мм', rrp: 490, axis1: '159 мм' },
    ],
    axisLabel: 'Размер',
  ...
  },
  {
    ...
    variants: [
      ...
      { sku: '41255', label: '140 мм', rrp: 460, axis1: '140 мм' },
      { sku: '41265', label: '165 мм', rrp: 460, axis1: '165 мм' },
    ],
    axisLabel: 'Размер',
